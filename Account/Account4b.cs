...
namespace Account4b {
    public class Person {
        ...
        public void writeAccounts() {
            ...
            //    Console.WriteLine($"Majitel: {myAccounts[i].owner.name} Ucet: {myAccounts[i].GetType().Name} Stav uctu: {myAccounts[i].balance},-");
            //}
    ...
    public class TestAccount {
        public static void Mainx() {
            ...
            Console.WriteLine("----------------");
            Console.WriteLine($"Jmeno: {o1.name} \t Stav: {o1.myAccounts[o1.countOfAccounts - 1].balance},-");
            o1.myAccounts[o1.countOfAccounts - 1].writeBalance();
            Console.WriteLine("----------------");
