...
namespace Account5 {
    ...
    public class Person {
        ...
        public override string ToString() {
            ...
            //}
            return $"{name} ({(DateTime.Now.Year - dateOfBirth.year)} let)";
        }
    }
    public class Account {
        ...
        //    age = 2023 - owner.dateOfBirth.year;
        //    this.balance = amount;
        ...
        public void writeBalance() {
            int age = 2023 - owner.dateOfBirth.year;
    ...
    public class TestAccount {
        public static void Mainx() {
            ...
            Account u6 = new Account(200, new Person("Pepa",new Date(19,4,1988)));
            Console.WriteLine("----------------");
