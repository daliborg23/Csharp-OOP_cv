...
namespace ThreadSort {
    public class Form5 : Form {
        ...
        public Form5(int[] arrayInput, string typRazeni) {
            ...
            int posX; int posY;
            posX = 500; posY = 500;
            this.SetDesktopLocation(posX+=250, posY+=250);
            ...
            this.trizeni();
            //Thread threadTrideni = new Thread(trizeni);
        ...
        public void PBMergeSort() {
            ...
            if (poleCisel.Length % 2 == 0) {
                ...
                polovina = poleCisel.Length / 2 - 1;
            }
            merge(poleCisel, 0, polovina, poleCisel.Length);
