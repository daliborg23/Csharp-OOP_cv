    ...
    public class ProgramKexc {
        ...
        public static void Main() {
            ...
            do {
                ...
                i++;
                try {
                    objInitField = (IServerInit)Activator.GetObject(typeof(IServerInit), srvAdr);
            ...
            Console.WriteLine("Zadavejte cisla pro vypocet a + 2 * b .");
            ...
            do {
                try {
                    ...
                    if (cislo1 != 0) {
                        Console.WriteLine("" + cislo1 + " + 2 * " + cislo2 + " = " + objAuthField.soucet(cislo1, cislo2));
                    }
                }
                catch (System.Net.Sockets.SocketException e) {
                    Console.WriteLine("Spojeni preruseno " + e.Message);
            ...
            //objAuth = null; // odhlaseni, spis by se mozna hodilo zrusit objekt na strane serveru? metoda na odhlaseni?
